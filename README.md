...
- **Sistema Anti-Histórias Abandonadas** - Identifica histórias sem atualização por 3+ meses
- **Modo Maratona** - Tempo estimado de leitura por história
- **Recomendação Inteligente** - Sugestões baseadas em hábitos de leitura
